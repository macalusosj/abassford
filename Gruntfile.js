module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    //       'css/galleria.classic.css': 'sass/galleria.classic.scss'
    //     }
    //   }
    // },
    ...
    cssmin: {
      combine: {
        files: {
          ...
          'css/galleria.classic.minified.css': 'css/prefixed/galleria.classic.css'
        }
      }
    },
    ...
    watch: {
      ...
      css: {
        files: ['sass/*.scss'],
        tasks: ['compass', 'autoprefixer', 'cssmin', 'comment-media-queries'],
        options: {
          spawn: false,
        }
      },
  ...
  grunt.registerTask('default', ['concat', 'uglify', 'compass', 'autoprefixer', 'cssmin', 'comment-media-queries', 'imagemin', 'grunticon:myIcons', 'jekyll:server']);
